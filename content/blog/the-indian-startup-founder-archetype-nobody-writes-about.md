...
1. **Ask what the founder ships themselves.** Not "leads." Not "sets direction for." *Ships.* Code, decks, sales calls, customer emails — pick a lane, but they should be doing the work in *some* lane. If the answer is "I stay strategic," walk.

2. **Ask to see last quarter's numbers.** Revenue, burn, runway, top three customers. If the founder can't cite them from memory — or worse, gets defensive about the question — you have your answer.

3. **Talk to two people who left.** Not the people the founder tells you to talk to. *Anyone else.* If the pattern is "founder is inspirational, execution was chaos, I burnt out," you have your second answer.

4. **Ask what the interns are working on, and whether they're paid a real wage.** Not "stipend." Not "we give them equity." A real number. A company that runs on unpaid students is telling you exactly how much it values labour, and it will value yours the same way as soon as you stop being new.

5. **Look at what the company spends on outside payroll.** Offsites, travel, "brand." If more of the money goes to the founder's visibility than to the team's output, the company is a personal-brand vehicle. Yours will be one of the assets.
...
*More opinion pieces at [thecoderpanda.com/blog](https://thecoderpanda.com/blog). If any of this rhymes with your own experience — I'd rather hear about it than pretend it's rare.*
